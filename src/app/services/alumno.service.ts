...
export class AlumnoService {
  ...
  updateAlumno(alumno: Alumno,idAlumno:number): Observable<Alumno> {
    return this.http.put<Alumno>(this.url+"/"+idAlumno+`?nombre=${alumno.nombre}&apellido=${alumno.apellido}&email=${alumno.email}&edad=${alumno.edad}`, alumno);
  }
